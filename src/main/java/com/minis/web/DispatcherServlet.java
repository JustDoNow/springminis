...
public class DispatcherServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		System.out.println("sContextConfigLocation:" + sContextConfigLocation);
		...
		// xmlPath:file:/Users/qizhi/shidian/codebases/springminis/web/WEB-INF/minisMVC-servlet.xml
		Resource rs = new ClassPathXmlResource(xmlPath);
		XmlConfigReader reader = new XmlConfigReader();
		mappingValues = reader.loadConfig(rs);
		System.out.println("mappingValues:" + mappingValues);
		Refresh();
	}
